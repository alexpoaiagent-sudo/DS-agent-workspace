...
> Находок: 1 | Capture-кандидатов: 7 | WP-предложений: 0
> **Статус ревью:** ✅ проверен (24 мар). Принято: #1, #2, #7, #8, #10. Доработка: #3-#6 (повторы → enrichments accepted). Отклонён: #9. Правило #13 добавлено.

## Статус заданий (backlog)

  - id: rt-001	    title: "Реальные кейсы автономных агентов в проде"	    status: pending
  - id: rt-003	    title: "Fundraising best practices для seed-раунда EdTech/Intelligence Platform"	    status: pending
  - id: rt-004	    title: "SOTA методы бизнес-моделирования для EdTech/SaaS"	    status: pending
  - id: rt-002	    title: "SOTA методы написания текстов для соцсетей (антидетект AI)"	    status: pending
